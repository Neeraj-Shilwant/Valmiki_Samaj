    ...
    <nav id="header" className="bg-white fixed w-full z-10 top-0 shadow">
      <div className="w-full container mx-auto flex flex-wrap items-center justify-between my-4">
        <div className="pl-4 md:pl-0">
            ...
            <Link className="flex items-center text-yellow-600 text-base xl:text-xl no-underline hover:no-underline font-extrabold font-sans" href="/" >
        <img src="/valmiki_logo.png" alt="" style={{maxWidth:"9%"}} className="img-fluid"/>
        ...
        <div className={`${style.userMenu} pr-0 flex justify-end`}>
          <div className="flex relative  float-center">
            <div className="relative text-sm">
              ...
              >
                <div style={{padding:"1%"}}>
                महाराष्ट्रातील सर्व वाल्मिकी समाज बांधवांची ओळख आणि एकत्रित <br/> माहिती करण्यासाठी आम्ही समाजाची जनगणना उपक्रम राबवत आहोत. या जनगणनेद्वारे आपण ब्लड ग्रुप, व्यवसाय, कुटुंबातील हॅंडीकॅप व्यक्ती, कलाकार, खेळाडू, आणि इतर सामाजिक कार्यांची माहिती घेत आहोत. फॉर्म सोपा ठेवण्यासाठी काही ठिकाणी ऑप्शन टॅब दिले आहेत. मुख्य कुटुंबीयांशिवाय आणखी व्यक्ती असतील, तर त्यांची नोंद करण्यासाठी फॉर्म दुसऱ्यांदा भरावा लागेल.
         </div>  
              </div>
            </div>
          </div>
